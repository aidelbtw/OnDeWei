# OnDeWei
Repository for OnDeWei WIA1002 (Data Structures) Semester 2 25/26 Project.
...
CREATE YOUR OWN BRANCH (DO THIS WHEN FIRST TIME DOING A CODE, IT IS TO CREATE A BRANCH (like a copy) THAT WONT AFFECT THE MAIN CODE IN CASE SOMETHING GOES WRONG):
...
WHEN CODING, DO THIS (check if you have something like C:\Users\User\KedaiRuncit in your cmd, if dont have then do - cd KedaiRuncit)
git checkout yourname-feature
git pull origin main
code .
CAN START EDITING YOUR FILES
THIS IS FOR WHEN YOU FINISH AND WANT TO PUSH TO THE GITHUB
